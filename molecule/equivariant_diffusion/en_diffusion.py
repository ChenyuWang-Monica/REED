...
class GammaNetwork(torch.nn.Module):
    """The gamma network flowmodels a monotonic increasing function. Construction as in the VDM paper."""
    def __init__(self):
        super().__init__()
...
class EnVariationalDiffusion(torch.nn.Module):
    ...
    def sample_p_xh_given_z0(self, z0, node_mask, edge_mask, context, fix_noise=False, rep=None):
        """Samples x ~ p(x|z0)."""
    ...
    def sample_p_zs_given_zt(self, s, t, zt, node_mask, edge_mask, context, fix_noise=False, rep=None):
