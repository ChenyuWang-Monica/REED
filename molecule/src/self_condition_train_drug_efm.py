...
import hydra           
@hydra.main(config_path="../configs", config_name="drug_efm_config.yaml", version_base="1.3")
def main(args):
    ...
    if rank == 0:
        ...
        kwargs = {'entity': pcdm_args.wandb_usr, 'name': pcdm_args.exp_name, 'project': 'e3_flow_matching', 'config': {k: v for k, v in args.items()},
