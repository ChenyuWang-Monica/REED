...
class GtSampler(BaseRepSampler):
    def __init__(self, encoder, raw_dataset, collate_fn=None, debug=False):
...
def initilize_rep_sampler(rep_sampler_args, dataset_args=None, debug=False):
    ...
    if rep_sampler_args.sampler == "GtSampler":
        ...
        try:
            ...
            which_split = "edm"
        # this is the original dataset used in the main branch, but we need to use Smol dataset for semlaflow
        ...
        elif dataset_args.dataset == "geom-drugs":
        ...
        rep_sampler = GtSampler(encoder=encoder, raw_dataset=train_dataset, collate_fn=None, debug=debug)
