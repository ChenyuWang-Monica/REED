...
from models.torchmdnet.models import output_modules
from models.torchmdnet.models.wrappers import AtomFilter
from models.torchmdnet import priors
import warnings
...
def create_model(args, prior_model=None, mean=None, std=None, only_representation=True):
    ...
    if args["encoder_model"] == "graph-network":
        from models.torchmdnet.models.torchmd_gn import TorchMD_GN
        ...
        from models.torchmdnet.models.torchmd_t import TorchMD_T
        ...
        from models.torchmdnet.models.torchmd_et import TorchMD_ET
    ...
    if args["prior_model"] and prior_model is None:
        ...
        assert hasattr(priors, args["prior_model"]), (
            ...
            f'Available flowmodels are {", ".join(priors.__all__)}'
        )
        ...
        if not output_model.allow_prior_model and prior_model is not None:
            ...
            rank_zero_warn(
                (
                    ...
                    "not allow prior flowmodels. Dropping the prior model."
                )
            )
