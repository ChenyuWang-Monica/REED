...
def download_model(model_name):
    ...
    if not os.path.isfile(local_path):
        ...
        web_path = f'https://www.dropbox.com/scl/fi/a3vnv1qc4ap8573zzgxhx/last.pt?rlkey=urr4txqqh8ar33plraeq5diko&st=r1bocxgu&dl=0'
...
def load_encoders(enc_type, device, resolution=256):
    ...
    assert resolution == 256, "Currently, we only support 256x256 experiments."
